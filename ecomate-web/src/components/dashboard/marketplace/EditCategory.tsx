...
interface EditCategoryProps {
  item: RouterOutputs["admin"]["marketplace"]["getCategoryList"][0];
  onUpdateItem: (data: RouterInputs["admin"]["marketplace"]["updateCategory"]) => Promise<void>;
}

export const EditCategory = ({ onUpdateItem, item }: EditCategoryProps) => {
